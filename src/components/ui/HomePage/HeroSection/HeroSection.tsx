  ...
  return (
    <Container sx={{
     ...
     <Box sx={{
        ...
        <Typography  sx={{ my:4}} color="secondary.main"  variant="h6" component="p" fontWeight={600}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum, tenetur. Earum provident sed recusandae molestiae voluptatum nisi ratione nostrum rem, beatae deserunt 
            </Typography>
            <Button>Make Appointment</Button>
            <Button sx={{marginLeft:"10px"}} variant="outlined">Contact Us</Button>
   ...
   <Box sx={{
    ...
    <Image src={assets.images.doctor3} alt="doctor2" width={240} height={240}/>
   </Box>
   <Box sx={{
    position:"absolute",
 bottom: "-50px",
