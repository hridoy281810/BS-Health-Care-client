...
const TotalCountForDoctor = ({revenue,patientCount,appointmentCount,reviewCount}:TMetaDataProps) => {
  ...
  return (
    ...
    <div className="flex bg-gradient-to-r from-blue-500 to-indigo-500 text-white md:px-8 md:py-10 rounded items-center gap-4">
      ...
      <div>
        <p className="md:text-5xl font-semibold">{patientCount | 0}</p>
...
export default TotalCountForDoctor;